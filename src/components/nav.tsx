            ...
            <li key={item.href} className="flex-1">
              <Link
                ...
                className={cn(
                  ...
                  /**
                   * ยุบลงทันทีที่นิ้วแตะ ไม่ต้องรอเซิร์ฟเวอร์
                   *
                   * แถบนี้เป็นของที่กดบ่อยที่สุดในแอป แต่เดิมไม่มีอะไรตอบสนอง
                   * ตอนกดเลย — ทุกหน้าเป็น server-rendered การกดจึงเงียบอยู่
                   * ราว 250ms ก่อนหน้าจะเปลี่ยน ซึ่งเป็นจังหวะที่ทำให้รู้สึก
                   * เหมือนกดลิงก์บนเว็บ ไม่ใช่กดปุ่มในแอป
                   *
                   * ย่อแค่ 4% กับหรี่ลงนิดเดียว พอให้นิ้วรู้ว่าโดนแล้ว
                   * ไม่ถึงกับกระโดดจนดูตลก
                   */
                  "transition-transform active:scale-[0.96] active:opacity-70",
                )}
              >
                {item.icon}
