...
> **อัปเดตฐานข้อมูลที่มีอยู่แล้ว** — ถ้าเคยสร้างตารางไว้ก่อนที่จะมีเรื่องการโอนเงิน
> ให้รัน [supabase/add-transfers.sql](../supabase/add-transfers.sql) ที่ SQL Editor ครั้งเดียว
> เพิ่มตาราง `transfers` อย่างเดียว ไม่แตะข้อมูลเดิม รันซ้ำได้ปลอดภัย
> ถ้าไม่รัน แท็บ "บัญชี" จะเปิดไม่ได้เพราะหาตารางไม่เจอ
